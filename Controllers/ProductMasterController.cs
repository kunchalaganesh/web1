...
namespace JewelleryWebApplication.Controllers
{
    ...
    public class ProductMasterController : ControllerBase
    {
        ...
        public async Task<IActionResult> InsertProduct()
        {
            ...
            if (ModelState.IsValid)
            {
                List<tblRFID> list = new List<tblRFID>();
        ...
        public async Task<IActionResult> BulkUpdateProduct(List<tblProduct> list)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                List<tblRFID> secretlist = new List<tblRFID>();
                foreach (var model in list)
                {
                    tblProductsDetails tblProductsDetails = new tblProductsDetails();
                    //tblSecret tblSecret1 = new tblSecret();
                    tblProduct product = new tblProduct();
                    var secretdata = _tblSecretRepository.All().Where(x => x.BarcodeNumber == model.BarcodeNumber).FirstOrDefault();
                    if (secretdata != null)
                    {
                        return Ok(new { staus = "success", message = "Barcode Number Does Not Match" });
                    }
                    ...
                    if (products != null)
                    {
                       ...
                       var boxdata=_boxmasterRepository.All().Where(x => x.Id==model.BoxId).FirstOrDefault();
                        ...
                        product.OnlineStatus = "Active";
                        tblProductsDetails.tidValue = secretdata.TID;
                        ...
                        tblProductsDetails.product = model.ItemType;
                    ...
                    tblProductsDetails.tagtransaction = "";
                        ...
                        //tblSecret1.BarcodeNumber = tblProductsDetails.barcodeNumber;
                        //tblSecret1.TID = tblProductsDetails.tidValue;
