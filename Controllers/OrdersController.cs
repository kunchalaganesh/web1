    ...
    {  // public readonly IUnitOfWork _unitOfWork;
        ...
        private async Task sendEmail(int Id)
        {
            ...
            if (productdata.MRP != 0)
            {
                ...
                totalnetwt = Convert.ToDecimal(productdata.NetWt);
                var finalPrice = MRP + totaltax;
                grossTotalRate = totalsaleamount;
                netamount = finalPrice;
                totalgrwt = Convert.ToDecimal(productdata.grosswt) * Convert.ToDecimal(orderdata.Qty);
            ...
            else
            {
                ...
                totalnetwt = Convert.ToDecimal(productdata.NetWt) * Convert.ToDecimal(orderdata.Qty);
                totalgrwt = Convert.ToDecimal(productdata.grosswt) * Convert.ToDecimal(orderdata.Qty);
